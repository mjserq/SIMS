...
<center><strong>From : <input type="text" style="width: 223px; height:35px; color:#222;" name="d1" class="tcal" value="" /> To: <input type="text" style="width: 223px; height:35px; color:#222;" name="d2" class="tcal" value="" />
